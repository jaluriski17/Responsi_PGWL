...
<body>
    <nav class="navbar navbar-expand-lg bg-body-tertiary">
        <div class="container-fluid">
            <a class="navbar-brand" href="#"><i class="fa-solid fa-earth-asia"></i>PETA Cilacap Jelajah Numsantara</a>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <form method="POST" action="{{ route('logout') }}" class="d-inline">
                            @csrf
                            <button class="nav-link btn btn-link" type="submit"><i class="fa-solid fa-left-to-bracket"></i> Logout</button>
                        </form>
                    </li>
                    @else
                    <li class="nav-item">
